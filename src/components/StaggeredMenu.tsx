            ...
            >
              ...
              >
                ...
                >
                  {textLines.map((l, i) => (
                    <span
                      className="sm-toggle-line block h-[1em] font-semibold text-foreground leading-none"
                      key={i}
                    >
                      {l}
                    </span>
              ...
              <span
                ref={iconRef}
                className="sm-icon relative w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform] text-foreground"
                aria-hidden="true"
              >
                <span
                  ref={plusHRef}
                      ...
                      <a
                        ...
                        onClick={(e) => {
                          if (it.link.startsWith("#")) {
                            e.preventDefault();
                            const targetEl = document.querySelector(it.link);
                            if (targetEl) {
...
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 2.4rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
