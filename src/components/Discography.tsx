...
const NoweRozdanieIframe = () => {
    return <iframe data-testid="embed-iframe" style={{borderRadius: "12px"}}
                   src="https://open.spotify.com/embed/track/1ZPYNtCNTDXj4tJzaXCQWS?utm_source=generator" width="100%"
                   height="352" frameBorder="0" allowFullScreen=""
                   allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"
                   loading="lazy"></iframe>
}
const Discography = () => {
    const myCards = [
        ...
        {
            id: 2, title: "Karta 2", bg: "bg-blue-500",
            iframe: GhostingIframe
        },
        {
            id: 3, title: "Karta 3", bg: "bg-green-500",
            iframe: ChceZapomniecIframe
        },
        {
            id: 4, title: "Karta 4", bg: "bg-yellow-500",
